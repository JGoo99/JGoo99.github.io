...
_ex1) 몇 월인지 입력받은 후 계절을 출력하는 예제_
...
_ex3) 주민등록번호를 입력받아 성별을 구별하는 예제_
...
_ex3) 누적합계가 100이 넘지 않는 제일 큰 수를 구하는 예제_
...
_ex4) 더할 숫자를 입력받다가 0을 입력받으면 총 합을 구하는 예제_
